    ...
    return (
        <div className="aboutme">
            ...
            <ul className="linkinfo">
                <li><a href="mailto:JGeho@gmail.com"><BsEnvelopeOpenFill className="icons"/></a></li>
                <li className="icons"><a href="https://github.com/JGeho"><BsGithub className="icons"/></a></li>
                <li className="icons"><a href="https://linkedin.com/in/justin-geho"><BsLinkedin className="icons"/></a></li>
            </ul>
        </div>
    );
}
